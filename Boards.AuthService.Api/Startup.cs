...
using Boards.AuthService.Core.Profiles;
using Boards.AuthService.Core.Services;
...
namespace Boards.AuthService.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContext>(options => options.UseNpgsql(connection,  
                x => x.MigrationsAssembly("Boards.AuthService.Database")));
